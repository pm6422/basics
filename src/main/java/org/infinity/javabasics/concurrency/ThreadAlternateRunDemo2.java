...
public class ThreadAlternateRunDemo2 extends Thread {

    private Object lock;

    private int startIndex;

    public ThreadAlternateRunDemo2(String name, Object lock, int startIndex) {
        super.setName(name);
        this.lock = lock;
...
//                            System.out.println(Thread.currentThread().getName() + " obtained monitor");
    ...
    public static void main(String[] args) {
        ...
        new ThreadAlternateRunDemo2("EvenThread", lock, 0).start();
        new ThreadAlternateRunDemo2("OddThread", lock, 1).start();
    }
}
